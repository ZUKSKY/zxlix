    ...
    return (
      ...
      >
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <Link href="/" className="inline-flex items-center gap-2 rounded-full border border-sky-400/40 bg-sky-500/90 px-5 py-2.5 text-sm font-bold text-white shadow-[0_4px_14px_rgba(56,189,248,.35)] transition-colors hover:bg-sky-500">
